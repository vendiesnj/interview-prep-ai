...
export default function TermsPage() {
  return (
    <main style={{ maxWidth: 900, margin: "0 auto", padding: "40px 18px", color: "var(--text-primary)" }}>
      <h1 style={{ fontSize: 36, fontWeight: 700, margin: 0 }}>Terms of Service</h1>
      ...
      <section style={{ marginTop: 26, lineHeight: 1.7, color: "rgba(229,231,235,0.9)" }}>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, marginTop: 28 }}>Service overview</h2>
        <p>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, marginTop: 28 }}>Accounts</h2>
        <p>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, marginTop: 28 }}>Acceptable use</h2>
        <ul>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, marginTop: 28 }}>Payments & subscriptions</h2>
        <p>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, marginTop: 28 }}>Intellectual property</h2>
        <p>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, marginTop: 28 }}>Disclaimers</h2>
        <p>
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, marginTop: 28 }}>Changes to terms</h2>
        <p>
