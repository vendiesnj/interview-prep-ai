        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", gap: 28, alignItems: "start" }}>
          ...
          <div>
            ...
            <div style={{ marginBottom: 48 }}>
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 0.8, color: "#10B981", textTransform: "uppercase", marginBottom: 16 }}>Practice & Tools</div>
              <div style={{ display: "grid", gap: 12 }}>
                {TODOS.map((todo) => (
                  <div key={todo.id} style={{ padding: "18px 20px", borderRadius: "var(--radius-xl)", border: "1px solid var(--card-border)", background: "var(--card-bg)", display: "flex", gap: 16, alignItems: "center" }}>
                    ...
                    <Link href={todo.href} style={{ flexShrink: 0, padding: "9px 18px", borderRadius: "var(--radius-md)", background: todo.color, color: "#fff", fontWeight: 700, fontSize: 13, textDecoration: "none" }}>
                      Start →
                    </Link>
                  </div>
                ))}
            ...
            {/* Resources */}
            <div>
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 0.8, color: "#10B981", textTransform: "uppercase", marginBottom: 16 }}>Guides & Resources</div>
